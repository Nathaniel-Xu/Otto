---
description: Create a new skill or prompt template in the Otto extension.
---
...
**Location**: Prompt templates in the Otto extension MUST be placed in `~/.omp/agent/extensions/otto/commands/<name>.md`.
